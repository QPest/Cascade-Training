...
opencv_traincascade -data data -vec positives.vec -bg bg.txt -numPos 115 -numNeg 1000 -numStage 15 -w 20 -h 20 -min -precalcValBufSize 6000 -precalcIdxBufSize 6000 -mode ALL
